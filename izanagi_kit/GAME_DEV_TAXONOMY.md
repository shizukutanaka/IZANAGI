...
- C4 archetype storage ⬜ / C5 変更検知（dirty/changed）⬜ / C6 エンティティ関係（parent/child, relations）⬜
...
- I3 タイルマップ層（複数レイヤ）⬜ / I4 オートタイル ⬜ / I5 WFC 生成 ⬜ / I6 マルチレベル/階層 ⬜
...
- J6 ステアリング/influence map ⬜ / J7 FSM / behavior tree ⬜ / J8 JPS / weighted A* ⬜
...
- L1 ターンスケジューラ（energy system）✅ `turn` / L2 ステータス/戦闘式 ⬜ / L3 インベントリ/アイテム ⬜ / L4 状態異常（buff/debuff の期限管理）✅ `status`
