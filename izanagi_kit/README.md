...
| `hexgrid` | Axial-coordinate hex math (`Hex`, `DIRECTIONS`, `distance`, `line`, `ring`, `spiral`, odd/even-r offset conversion, `random_in_range`) — the redblobgames recipe set, integer-exact and `DetHash`-pinned. |
